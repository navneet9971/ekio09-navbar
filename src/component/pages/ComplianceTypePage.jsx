...
function Stepper() {
    ...
    <div class="row">
      <div className="col">
        <div>
          ...
          <h3 className="tc">TEC</h3>
          <div className="circle12">
            {current >= 2 ? <TiTick size={24} /> : null}
          </div>
          <h3 className="wp">WPS</h3>
        </div>
      </div>
        ...
        <div>
          ...
          <h3 className="be">BEE</h3>
          <div className="circle12">
          {current >= 2 ? <TiTick size={24} /> : null}
          </div>
          <h3 className="bi">BIS</h3>
        </div>
    </div>
  ...
  <div className="col">
    ...
    <h3 className="ep">EPR</h3>
    <div className="circle12">
    {current >= 2 ? <TiTick size={24} /> : null}
    </div>
    <h3 className="legal">Legal Metrology</h3>
    </div>
    <div className="col">
    <div className="circle12">
    {current >= 2 ? <TiTick size={24} /> : null}
    </div>
    <h3 className="isi">Mandatory ISI</h3>
    <div className="circle12">
    {current >= 2 ? <TiTick size={24} /> : null}
    </div>
    <h3 className="management">Management System</h3>
    </div>
    </div>
    )}
    </div>
