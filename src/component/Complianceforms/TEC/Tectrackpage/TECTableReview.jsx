...
function TECTableReview() {
  ...
  const history = useHistory();
    ...
    useEffect(() => {
      const storedTECTableData = localStorage.getItem('TECtableData');
      const TECTableData = JSON.parse(storedTECTableData);
      if (TECTableData) {
        setTableData(TECTableData);
      }
    }, []);
