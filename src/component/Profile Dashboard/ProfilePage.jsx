    ...
    <>
      ...
      <div style={{ display: "flex", marginTop: "20px" }}>
        ...
        <div style={{ backgroundColor: "lightblue", width: "300px", height: "100%" }}>
          <SidebarItem icon={<FaAngleRight />} text="Profile" />
          <hr style={{ margin: "8px 0" }} />
          <SidebarItem icon={<FaAngleRight />} text="Manage Clients" />
          <hr style={{ margin: "8px 0" }} />
          <SidebarItem icon={<FaAngleRight />} text="Analytics" />
          <hr style={{ margin: "8px 0" }} />
          <SidebarItem icon={<FaAngleRight />} text="Orders" />
        </div>
